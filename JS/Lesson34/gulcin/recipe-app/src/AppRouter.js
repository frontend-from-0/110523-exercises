...
export const AppRouter = ({ recipes , setRecipes }) => {
    ...
    return (
        <Routes>
            <Route path='user'>
                <Route path='register' element={<><Header setRecipes={setRecipes}  /><RegistrationForm /></>} />
            ...
            <Route path='admin'>
                ...
                <Route path='settings' element={<><Header setRecipes={setRecipes} /><Settings /></>} />
            </Route>

            <Route path='recipes'>
                <Route path='new' element={<><Header setRecipes={setRecipes} /><NewRecipe /></>} />
                <Route path=':id/details' element={<><Header setRecipes={setRecipes} /><RecipeDetails /></>} />
                <Route  path='search/:input' element={<><Header setRecipes={setRecipes} /><RecipeList recipes={recipes}/></>} />
                <Route  path='recipelist' element={<><Header setRecipes={setRecipes} /><RecipeList recipes={recipes}/></>} />
