...
const myFirstName = "Goksel" ;
const myLastName = "AGAN" ;
const myFullName = myFirstName + myLastName ;

console.log('Exercise 4:', myFullName);
...
let number30 = -3 ;
number30 ++ ;
let result20 = number30 * 2 ;
console.log('Exercise 12:', result20);
...
console.log('Exercise 13:' , result44);
