...
console.log(`${phrase} My name is ${myName}. I'm ${age} years old.`);
...
console.log("Exercise 4:", firstName);

console.log("Exercise 4.1:", fullName);
...
const date3 = TODAY_DATE.getDate();
const date4 = TODAY_DATE.getMonth();
const date5 = TODAY_DATE.getFullYear();
...
console.log("Exercise 9:", date1, date2, date3, date4, date5);
...
let number12 = -3;
number12++;
const result3 = number12 * 2;
console.log(result3);

console.log("Exercise 12:", result3);
...
++a;
const result4 = a + b;
console.log("Exercise 13:", result4);
