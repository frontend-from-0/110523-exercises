...
const string2Exercise12 =
	'Bundle deal: Save $50 when you buy two products together!';
const mark = "!";
console.log('Exercise12: ', string1Exercise12.endsWith(mark));
console.log('Exercise12: ', string2Exercise12.endsWith(mark));
...
//   stringExercise14.indexOf('searchString'), -1)
// );
console.log("Exercises14: " ,stringExercise14.substring(0, stringExercise14.indexOf("are") - 1) );
console.log('------------------------');
...
console.log('Exercise16: ', planPriceString.slice(planPriceString.indexOf('-') + 1, planPriceString.indexOf('/') ) );
console.log('------------------------');
...
const first = stringExercise20.charAt(0);
const last = stringExercise20.charAt(stringExercise20.length - 1);
const result= first + last ;
console.log('Exercise20: ', result.toUpperCase());
...
console.log('Exercise21: ', stringExercise21.substring(stringExercise21.indexOf("q"), stringExercise21.indexOf("jumps") -1) );
...
console.log('Exercise22: URL 1 is valid:', url1Exercise22.endsWith(".com") || url1Exercise22.endsWith(".org"));
console.log('Exercise22: URL 2 is valid:', url2Exercise22.endsWith(".com") || url2Exercise22.endsWith(".org"));
...
console.log('Exercise23a: ', string1Exercise23.includes("apple") && string1Exercise23.includes("banana") );
console.log('Exercise23b: ', string2Exercise23.includes("apple") && string2Exercise23.includes("banana") );
console.log('Exercise23c: ', string3Exercise23.includes("apple") && string3Exercise23.includes("banana") );
